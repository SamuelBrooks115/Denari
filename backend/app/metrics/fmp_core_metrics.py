"""
fmp_core_metrics.py — Compute core financial metrics from normalized FMP data.
...
def compute_core_metrics_from_normalized(fin: NormalizedFinancials) -> Dict[str, Any]:
    """
    Compute core financial metrics from normalized financials.
    ...
    logger.info(f"Computed metrics for {fin.ticker} FY {fin.fiscal_year}")
