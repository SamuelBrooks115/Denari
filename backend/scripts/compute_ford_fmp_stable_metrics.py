"""
compute_ford_fmp_stable_metrics.py — Compute core metrics from normalized FMP /stable data.

This script loads normalized financials JSON and computes key financial metrics
for valuation purposes.

Example (PowerShell):
    python scripts/compute_ford_fmp_stable_metrics.py `
...
def main():
    ...
    try:
        ...
        # Handle structured format from build_ford_fmp_stable_normalized.py
