...
export const TeamCard = ({ name, role, onClick }: TeamCardProps) => {
  return (
    <Card
    ...
    >
      <CardContent className="p-6 text-center">
        <div className="w-32 h-32 mx-auto mb-4 rounded-full bg-gradient-card flex items-center justify-center">
